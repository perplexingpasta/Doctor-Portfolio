...
const KnowTheDoctor = () => {
  return (
    <div className="mx-auto flex max-w-[90vw] flex-col pt-20 font-montserrat md:w-full md:flex-row md:pt-24 lg:ml-24 lg:pt-0">
      ...
      <div className="pl-2 pt-4 text-base font-semibold text-gray-500 md:w-1/2 md:pl-10 md:pt-0 md:text-xl lg:pl-16 lg:text-3xl">
        <header className="text-2xl text-gray-800 md:text-3xl lg:text-4xl">
          Dr. Robert Zane
        </header>
