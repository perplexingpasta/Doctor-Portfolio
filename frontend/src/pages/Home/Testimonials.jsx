...
const Testimonials = () => {
  return (
    <div className="font-montserrat">
      ...
      <h1 className="flex items-center justify-center font-normal text-gray-500 md:text-3xl">
      ...
      <div className="mx-5 flex flex-col items-center px-10 md:flex-row md:justify-between">
        <div className="flex flex-col items-center justify-center py-8">
          ...
          <h1 className="text-center font-palanquin text-xl font-bold md:text-2xl">
            Morich Brown
          </h1>
        </div>
